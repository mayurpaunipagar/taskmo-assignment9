...
export default function Welcome() {
  ...
  const handleEngRating = (e) => {};
  return (
    <div className="myPhone">
      <img
        src={window.location.origin + "/images/LEAD.svg"}
        alt="lead_logo"
        className="leadLogo"
      />
      ...
      <div className="myForm">
        ...
        >
          <option
            ...
            hidden
          >
            Rate your English communication
          </option>
        </select>
        <div
          className="submitBtn glow"
          onClick={submitFunc}
